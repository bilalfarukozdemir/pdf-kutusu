...
|---|---|---|
| [`PDF-Kutusu-1.2.0-arm64-v8a.apk`](https://github.com/bilalfarukozdemir/pdf-kutusu/releases/download/v1.2.0/PDF-Kutusu-1.2.0-arm64-v8a.apk) | 21 MB | **Çoğu kişi bunu indirsin.** 2017 sonrası bütün telefonlar `arm64-v8a`. |
| [`PDF-Kutusu-1.2.0-universal.apk`](https://github.com/bilalfarukozdemir/pdf-kutusu/releases/download/v1.2.0/PDF-Kutusu-1.2.0-universal.apk) | 50 MB | Eski 32-bit cihazlar ve emülatörler. Emin değilseniz bunu indirin, her yerde çalışır. |
